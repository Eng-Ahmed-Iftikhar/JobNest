...
export function EmptyState({
  ...
  return (
    <View className="flex-1 items-center justify-center p-6">
      ...
      <Text className="text-base font-semibold text-black dark:text-white mb-1 text-center">
        {title}
      </Text>
      <Text className="text-sm font-medium text-gray-500 dark:text-gray-400 text-center mb-4">
        {description}
      </Text>
      <Pressable
        onPress={onAction}
